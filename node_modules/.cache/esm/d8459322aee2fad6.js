let assert,Library,Book;_aee‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_aee‍.w("../library",[["default",["Library"],function(v){Library=v}]]);_aee‍.w("../book",[["default",["Book"],function(v){Book=v}]]);
